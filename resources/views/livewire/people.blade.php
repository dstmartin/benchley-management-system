<div>
    ...
    <input id="search" type="text" wire:model="search" placeholder="Search directory by name, email, or phone number." />
    <p>{{ $search }}</p>

    <div id="directory">
        <div>
            Per Page &nbsp;
            <select wire:model="count" name="" id="count">
        ...
        <table class="table-auto">
            <thead>
                <tr>
                    ...
                    <th class="border px-4 py-2">
                        <a wire:click.prevent="sortBy('is_member')" role="button" href="#">
                            Member
